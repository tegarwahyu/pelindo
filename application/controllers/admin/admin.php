...
class Admin extends CI_Controller {
	...
	{
		$data['simpan1'] = $this->model_ticket->getTicketstatus1()->result();
		$data['simpan2'] = $this->model_ticket->getTicketstatus2()->result();
		$data['simpan3'] = $this->model_ticket->getTicketstatus3()->result();
		$data['simpan4'] = $this->model_ticket->getTicketstatus4()->result();
      	//$data['chart'] = json_encode($data1);
		...
		//$data['chart'] = $this->model_ticket->getTicket()->result();
	...
	public function listUsers()
	{
		...
		$data['users'] = $this->model_admin->get_listUsers();
		$data['content'] = $this->load->view('admin/view_users', $data, $statusbaru, TRUE); 
		$this->load->view('template/main', $data); 
	}
   ...
   //          );
	...
	{
		$data['title'] = 'Halaman Tabel Kriteria';
		$data['subtitle'] = 'Halaman untuk mengelola kriteria yang Digunakan';
		$data['criteria'] = $this->model_admin->get_listCriteria();
		$data['content'] = $this->load->view('admin/view_criteria', $data, TRUE); 
		$this->load->view('template/main', $data); 
	}
	...
	public function addCriteria()
	{
		if(isset($_POST['submit'])){
			...
			redirect('admin/admin/listCriteria');

		}
		else{
			$data['title'] = 'Halaman Add Kriteria';
			$data['subtitle'] = 'Halaman untuk menambahkan Kriteria secara singkat';
			$data['content'] = $this->load->view('admin/view_addcriteria', $data, TRUE); 
			$this->load->view('template/main', $data);
		}
	}	
