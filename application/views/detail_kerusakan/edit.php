		    ...
		    <div class="col-md-12">
	            <div class="card-body"><h5 class="card-title" style="text-align: center;">Form Edit Detail Kerusakan</h5>
	                ...
	                <form class="form-horizontal" action="<?php echo base_url('kerusakan/Detail_Kerusakan/editDetailKerusakan/'.$a->ID_DEMAGE_DETAILS);?>" method="post">
	                    ...
	                    <div class="form-row">
	                        <div class="col-md-12">
	                            <div class="position-relative form-group"><label for="exampleEmail11" class="">Nama Detail Kerusakan</label><input name="detail_kerusakan" id="detail_kerusakan" placeholder="<?php echo($a->NAME_DEMAGE_DETAILS);?>" type="text" class="form-control" required=""></div>
	                        </div>
	                    </div>
	                <?php } ?>
