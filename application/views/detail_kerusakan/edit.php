		                ...
		                <table class="mb-0 table" id="table_kerusakan_id">
					      ...
					      <?php 
		                    ...
		                    <tr>
		                        ...
		                        <td><a href="<?php echo base_url('kerusakan/Detail_Kerusakan/deleteDetailKerusakan/'.$u->ID_DEMAGE_DETAILS);?>" onclick="return confirm('Ingin menghapus data?');" class="btn btn-danger">Delete</a></td>
		                    </tr>
		                    </tbody>
		                <?php } ?>
					  </table>
		    ...
		    <div class="col-md-6">
		    	...
		    	<?php foreach($data as $a) { ?>
	                <form class="form-horizontal" action="<?php echo base_url('kerusakan/Detail_Kerusakan/editDetailKerusakan/'.$a->ID_DEMAGE_DETAILS); ?>" method="post">
	                	<input type="text" class="form-control" name="id_detail" value="<?php echo $a->ID_DEMAGE_DETAILS ?>">
	                    <div class="form-row">
	                        <div class="col-md-12">
