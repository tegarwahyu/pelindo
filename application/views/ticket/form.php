...
<div class="main-card mb-3 card">
    <div class="card-body"><h5 class="card-title">Pelaporan Tiket</h5>
        
         <form class="form-horizontal" action="<?php echo base_url('ticket/ticket/addTicket'); ?>" method="post">
            <div class="form-row">
                <div class="col-md-5">
                    <div class="position-relative form-group"><label for="exampleEmail11" class="">Subject</label><input name="subject" id="subject" placeholder="Masukkan Subject" type="text" class="form-control"></div>
                </div>
                <div class="col-md-3">
