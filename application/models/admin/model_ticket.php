...
class Model_ticket extends CI_Model 
{
  ...
  public function get_listticket(){
    ...
    public function get_listticket1(){
      ...
      $result = $this->db->query('SELECT * FROM TICKET JOIN TICKET_DETAILS ON TICKET.ID_TICKET_DETAILS=TICKET_DETAILS.ID_TICKET_DETAILS JOIN USERS ON TICKET_DETAILS.ID_USERS = USERS.ID_USERS ORDER BY ID_TICKET DESC');
      return $result;
    }
    ...
    public function view_detailticket($where)
    {
      ...
      $result = $this->db->query("SELECT * FROM TICKET JOIN TICKET_DETAILS ON TICKET.ID_TICKET_DETAILS=TICKET_DETAILS.ID_TICKET_DETAILS JOIN USERS ON TICKET_DETAILS.ID_USERS = USERS.ID_USERS WHERE TICKET_DETAILS.ID_TICKET_DETAILS = '$where'"); 
      return $result;
    }
  ...
  public function getTicketstatus1()
  {
     $result = $this->db->query('SELECT TICKET.STATUS AS STATUS, COUNT(TICKET.STATUS) AS JUMLAH FROM TICKET WHERE STATUS = 1 GROUP BY TICKET.STATUS');
      return $result;
  }

  public function getTicketstatus2()
  {
     $result = $this->db->query('SELECT TICKET.STATUS AS STATUS, COUNT(TICKET.STATUS) AS JUMLAH FROM TICKET WHERE STATUS = 2 GROUP BY TICKET.STATUS');
      return $result;
  }

  public function getTicketstatus3()
  {
     $result = $this->db->query('SELECT TICKET.STATUS AS STATUS, COUNT(TICKET.STATUS) AS JUMLAH FROM TICKET WHERE STATUS = 3 GROUP BY TICKET.STATUS');
      return $result;
  }

  public function getTicketstatus4()
  {
     $result = $this->db->query('SELECT TICKET.STATUS AS STATUS, COUNT(TICKET.STATUS) AS JUMLAH FROM TICKET WHERE STATUS = 4 GROUP BY TICKET.STATUS');
      return $result;
  }
